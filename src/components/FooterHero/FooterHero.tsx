        ...
        <div className="relative  py-5 pb-10">
            ...
            <Container>
                <div className="space-y-6 mb-6">
                    ...
                    <div className="">
                        <h1 className="text-[#000] max-w-xl mx-auto text-center md:font-medium text-4xl  md:text-6xl mb-[24px]">
                            Experience the
                            Future of Finance!
                        </h1>
                        <p className="text-[#585858] max-w-[577px] text-center text-sm md:text-base mx-auto">
